...
uint256 hashGenesisBlock("0x9f2f1539e079a7bbcb3ed76e269118c512e422dd5f752895d8eed15bedc6dd73");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Polcoin: starting difficulty is 1 / 2^12
...
{
    // Polcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 438000); // Polcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 4 * 60 * 60; // Polcoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Polcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // PolCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // PolCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Polcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7b7d45f6c5050f3ee3843b179a92429fbba8ddddf4a70658e7b0a03719dcc84e");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1393009200;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 504522;

        if (fTestNet)
        {
            block.nTime    = 1389974483;
            block.nNonce   = 51492;
        }
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Polcoin: increase each by adding 2 to bitcoin's value.
