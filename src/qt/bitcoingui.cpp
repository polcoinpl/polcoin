...
void BitcoinGUI::createActions()
{
    ...
    digAction = new QAction(QIcon(":/icons/mining"), tr("&Dig"), this);
    /*
    digAction->setStatusTip(tr("Dig"));
    digAction->setToolTip(digAction->statusTip());
    digAction->setCheckable(true);
    digAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
    ...
    */
    ...
    connect(digAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(digAction, SIGNAL(triggered()), this, SLOT(gotoDigPage()));

    quitAction = new QAction(QIcon(":/icons/quit"), tr("E&xit"), this);
    quitAction->setStatusTip(tr("Quit application"));
    quitAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_Q));
    quitAction->setMenuRole(QAction::QuitRole);
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Polcoin"), this);
